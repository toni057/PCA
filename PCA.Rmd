...
```{r, fig.align = "center", fig.height = 4, fig.width = 5, tidy.opts = list(width.cutoff = 70), tidy = TRUE}
library(ggplot2)
...
x1 <- rnorm(n, 0, 1); y1 <- rnorm(n, 0, 1); 

x2 <- rnorm(n, 2, 1); y2 <- rnorm(n, 2, 1)
...
```{r, fig.align = "center", tidy.opts = list(width.cutoff = 70), tidy = TRUE}
